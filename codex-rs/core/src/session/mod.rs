...
impl Session {
    ...
    pub(crate) async fn record_context_updates_and_set_reference_context_item(
        ...
        let turn_context = step_context.turn.as_ref();
        // ContextManager keeps the baseline used to compute turn-to-turn context changes.
        ...
        // The first turn builds full initial context; later turns emit only changes.
        ...
        // context items.
        let mut state = self.state.lock().await;
        // Advance ContextManager's reference point for the next turn.
